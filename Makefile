...
ACLOCAL = ${SHELL} /data/data/com.termux/files/pkg/ps/mono-4.9.0/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /data/data/com.termux/files/pkg/ps/mono-4.9.0/missing autoconf
AUTOHEADER = ${SHELL} /data/data/com.termux/files/pkg/ps/mono-4.9.0/missing autoheader
AUTOMAKE = ${SHELL} /data/data/com.termux/files/pkg/ps/mono-4.9.0/missing automake-1.14
AWK = awk
BOEHM_DEFINES = 
BTLS_ARCH = 
BTLS_CFLAGS = 
...
CCASFLAGS = -I/data/data/com.termux/files/usr/include -D__ANDROID__ -DISABLE_AOT=1 -DARM_FPU_NONE -DPLATFORM_ANDROID
CCDEPMODE = depmode=gcc3
CC_FOR_BUILD = gcc -fPIC -fPIE
CFLAGS = -I/data/data/com.termux/files/usr/include -D__ANDROID__ -DISABLE_AOT=1 -DARM_FPU_NONE -DPLATFORM_ANDROID -std=gnu99 -fno-strict-aliasing -fwrapv -Wno-zero-length-array -DMONO_DLL_EXPORT -g -Wall -Wunused -Wmissing-prototypes -Wmissing-declarations -Wstrict-prototypes  -Wmissing-prototypes -Wnested-externs -Wpointer-arith -Wno-cast-qual -Wwrite-strings -Wno-switch -Wno-switch-enum -Wno-unused-value -Wno-attributes -Qunused-arguments -Wno-unused-function -Wno-tautological-compare -Wno-parentheses-equality -Wno-self-assign -Wno-return-stack-address -Wno-constant-logical-operand -Werror-implicit-function-declaration
CFLAGS_FOR_BUILD = -I/data/data/com.termux/files/usr/include -D__ANDROID__ -DISABLE_AOT=1 -DARM_FPU_NONE -DPLATFORM_ANDROID
CMAKE = 
CPP = gcc -E -fPIC -fPIE
CPPFLAGS = -I/data/data/com.termux/files/usr/include -D__ANDROID__ -DISABLE_AOT=1 -DARM_FPU_NONE -DPLATFORM_ANDROID -DGC_LINUX_THREADS -D_GNU_SOURCE -D_REENTRANT -DUSE_MMAP -DUSE_MUNMAP -g -Wall -Wunused -Wmissing-prototypes -Wmissing-declarations -Wstrict-prototypes  -Wmissing-prototypes -Wnested-externs -Wpointer-arith -Wno-cast-qual -Wwrite-strings -Wno-switch -Wno-switch-enum -Wno-unused-value -Wno-attributes -Qunused-arguments -Wno-unused-function -Wno-tautological-compare -Wno-parentheses-equality -Wno-self-assign -Wno-return-stack-address -Wno-constant-logical-operand 
CXX = g++ -fPIC -fPIE
CXXCPP = g++ -E -fPIC -fPIE
CXXDEPMODE = depmode=gcc3
CXXFLAGS = -I/data/data/com.termux/files/usr/include -D__ANDROID__ -DISABLE_AOT=1 -DARM_FPU_NONE -DPLATFORM_ANDROID -fvisibility=hidden
CYGPATH_W = echo
DEFAULT_PROFILE = net_4_x
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = dlltool
DOLT_BASH = /data/data/com.termux/files/usr/bin/bash
DSYMUTIL = 
DTRACE = 
DTRACEFLAGS = 
DUMPBIN = 
...
LDFLAGS = -L/data/data/com.termux/files/usr/lib -Wl--export-dynamic
LIBC = libc.so.6
LIBGC_CPPFLAGS = 
LIBGC_LIBS = 
LIBGC_STATIC_LIBS = 
...
LIBOBJS = 
LIBS = -lc -ldl -lgnustl_shared  -llog -lgdiplus -lcairo -lfontconfig -lfreetype -lpng -lz -lglib-2.0 -lintl -lm  -lpthread  -lpthread
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /data/data/com.termux/files/pkg/ps/mono-4.9.0/missing makeinfo
MANIFEST_TOOL = :
...
XMKMF = 
abs_builddir = /data/data/com.termux/files/pkg/ps/mono-4.9.0
abs_srcdir = /data/data/com.termux/files/pkg/ps/mono-4.9.0
abs_top_builddir = /data/data/com.termux/files/pkg/ps/mono-4.9.0
abs_top_srcdir = /data/data/com.termux/files/pkg/ps/mono-4.9.0
ac_ct_AR = ar
ac_ct_CC = gcc -fPIC -fPIE
ac_ct_CXX = g++ -fPIC -fPIE
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /data/data/com.termux/files/pkg/ps/mono-4.9.0/install-sh
libdir = ${exec_prefix}/lib
libexecdir = ${exec_prefix}/libexec
libgc_dir = 
libgdiplus_install_loc = /data/data/com.termux/files/usr/lib
libgdiplus_loc = /data/data/com.termux/files/usr/lib
libmono_cflags = -D_REENTRANT
libmono_ldflags =  -lc -ldl -lgnustl_shared  -llog -lgdiplus -lcairo -lfontconfig -lfreetype -lpng -lz -lglib-2.0 -lintl -lm  -lpthread  -lpthread
libsuffix = .so
localedir = ${datarootdir}/locale
localstatedir = ${prefix}/var
mandir = ${datarootdir}/man
mcs_topdir = /data/data/com.termux/files/pkg/ps/mono-4.9.0/mcs
mcs_topdir_from_srcdir = $(top_builddir)/mcs
mkdir_p = $(MKDIR_P)
mono_build_root = /data/data/com.termux/files/pkg/ps/mono-4.9.0
