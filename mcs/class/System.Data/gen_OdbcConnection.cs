...
namespace System.Data.Odbc {
    ...
    public sealed partial class OdbcConnection : DbConnection {
        ...
        internal static readonly System.Security.CodeAccessPermission ExecutePermission = OdbcConnection.CreateExecutePermission();
        ...
        // Copy Constructor
        private void CopyFrom(OdbcConnection connection) { // V1.2.3300
        ...
        private static System.Security.CodeAccessPermission CreateExecutePermission() {
            DBDataPermission p = (DBDataPermission)OdbcConnectionFactory.SingletonInstance.ProviderFactory.CreatePermission(System.Security.Permissions.PermissionState.None);
        ...
        private void EnlistDistributedTransactionHelper(System.EnterpriseServices.ITransaction transaction) {
            ...
            permissionSet.AddPermission(OdbcConnection.ExecutePermission); // MDAC 81476
