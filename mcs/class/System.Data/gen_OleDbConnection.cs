...
namespace System.Data.OleDb {
    ...
    public sealed partial class OleDbConnection : DbConnection {
        ...
        internal static readonly System.Security.CodeAccessPermission ExecutePermission = OleDbConnection.CreateExecutePermission();
        ...
        private static System.Security.CodeAccessPermission CreateExecutePermission() {
            DBDataPermission p = (DBDataPermission)OleDbConnectionFactory.SingletonInstance.ProviderFactory.CreatePermission(System.Security.Permissions.PermissionState.None);
        ...
        private void EnlistDistributedTransactionHelper(System.EnterpriseServices.ITransaction transaction) {
            ...
            permissionSet.AddPermission(OleDbConnection.ExecutePermission); // MDAC 81476
